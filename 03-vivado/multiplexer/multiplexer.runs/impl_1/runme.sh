...
HD_PWD='V:/digital-electronics-1/digital-electronics-1/03-vivado/multiplexer/multiplexer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_3bit_4to1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_3bit_4to1.tcl -notrace
