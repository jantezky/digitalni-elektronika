...
#set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports {  }]; #IO_L24N_T3_34 Sch=sw[8]
#set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports {  }]; #IO_25_34 Sch=sw[9]
...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { out_i[0] }]; #IO_L18P_T2_A24_15 Sch=led[0]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { out_i[1] }]; #IO_L24P_T3_RS1_15 Sch=led[1]
